...
export default function FormLayout({ children }: FormLayoutProps) {
  return (
    <div className="flex flex-row justify-center gap-4 lg:gap-8 w-full h-full p-6 ">
      {/* content section */}
      <main className="flex flex-col justify-center items-center w-full max-w-148.5 h-full gap-4 md:gap-8">
